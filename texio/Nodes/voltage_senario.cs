...
{
    static Vector.Tools.Timer power_off_delay;

    public override void Initialize()
    {
        power_off_delay = new Timer(new TimeSpan(20*1000*1000), OnPowerOffDelayElapsed); // 2秒後にoffする
...
/////
    /////
    // 2secタイマ経過ハンドラ
    private static void OnPowerOffDelayElapsed(object sender, ElapsedEventArgs e)
    {
